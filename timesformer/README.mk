...
0-获取标记数据                         # 得到标记数据.json
1-标记数据to精简数据                   # 得到精简数据.json  # 标记数据存在很多不需要的信息，提取出需要的字段，至少需要的字段，video_id(video_name),label_id,label_name,start,end
...
6-测试模型                             # 调用生成的checkpoint，对测试集进行测试
7-数据统计                             # 测试结果数据统计，产生预测输出日志和直方图
